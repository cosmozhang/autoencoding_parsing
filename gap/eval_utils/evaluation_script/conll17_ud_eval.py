...
def evaluate(gold_ud, system_ud, deprel_weights=None):
    ...
    if gold_ud.characters != system_ud.characters:
        # print(gold_ud.characters[:20])
        # print(system_ud.characters[:20])
        index = 0
        ...
        raise UDError(
            ...
            "First 20 differing characters in gold file: '{}' and system file: '{}'".format(
                "".join(gold_ud.characters[max(0, index-2):index + 20+2]),
                "".join(system_ud.characters[max(0, index-2):index + 20+2])
            )
        )
